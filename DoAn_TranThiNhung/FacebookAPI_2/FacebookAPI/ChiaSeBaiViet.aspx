<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiaSeBaiViet.aspx.cs" Inherits="FacebookAPI.ChiaSeBaiViet" %>
...
<body>
    ...
    <li class="dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Chia sẻ <span class="caret"></span></a>
    <ul class="dropdown-menu">
    <li class="active"><a href="#">Chia sẻ bài viết</a></li>
    <li><a href="#">Chia sẻ ảnh</a></li>
    </ul>
    </li>
    <li><a href="#">Lấy thông tin User trên Facebook</a></li>
    <li><a href="#">Thông báo trên Facebook</a></li>
    ...
    <section id="services" class="padding50">
        <div class="container">
            <div class="row">
                <h2 class="background double animated wow fadeInUp" data-wow-delay="0.2s"><span>Chia sẻ</span></h2>
            </div>
            <!-- ./ end row -->
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                            Chia sẻ trên Facebook</h4>
                        <p>
                            Chia sẻ là cách đơn giản để cho phép mọi người đưa nội dung từ ứng dụng di động hoặc trang web của bạn lên Facebook. 
                            </p>
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-8">
                    ...
                    <div class="sc-inner">
                        <h4>
                            Chia sẻ lên dòng thời gian của bản thân</h4>
                        <p> <img src="images/chia-se-bai-viet.jpg" /></p>
                    </div>
                </div>
                <!-- ./ end service box -->
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>Loại nội dung</h4>
                        <p>
                            <b>Liên kết</b> - Hầu hết nội dung là URL tham chiếu một trang HTML. <br />
                           <b>Ảnh</b>  - Tải lên trực tiếp một hoặc nhiều ảnh do người dùng tạo.<br />
                           <b>Video</b>  - Tải lên trực tiếp video do người dùng tạo.<br />
                           <b>Đa phương tiện</b>  - Tải lên trực tiếp kết hợp của ảnh và video.</p>
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-8">
                    ...
                    <div class="sc-inner">
                        <h4>
                            Chia sẻ lên tường nhà bạn bè</h4>
                        <p><img src="images/chia-se-hinh-anh.jpg" />
                            </p>
                    </div>
                </div>
