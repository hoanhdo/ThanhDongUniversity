<%@ Page Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="ChiaSeTrenPage.aspx.cs" Inherits="FacebookAPI.Admin.ChiaSeTrenPage" %>
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Chia sẻ bài viết trên Page mình làm quản trị
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label>Danh sách các Page</label>
                                            <div class="checkbox">
                                                <label>
                                                    <asp:CheckBoxList ID="cblAccounts" runat="server">
                                                    </asp:CheckBoxList>
                                                </label>
                                            </div>
                                        </div>
